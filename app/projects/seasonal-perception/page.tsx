...
export default function ProjectDetail() {
  const project = PROJECTS.find((p) => p.id === 'liu2025inner')

  const images = [
    '/img/projects/Portfolio_Zhengyang Li_0116(1)_09.png',
    '/img/projects/Portfolio_Zhengyang Li_0116(1)_10.png',
    '/img/projects/Portfolio_Zhengyang Li_0116(1)_11.png',
    '/img/projects/Portfolio_Zhengyang Li_0116(1)_12.png',
    '/img/projects/Portfolio_Zhengyang Li_0116(1)_13.png',
  ]
  ...
  const orderedLinks = [
    ...
    { label: 'Conference', url: project.links?.['eCAADe 2025'] },
