...
export default function ProjectDetail() {
  const project = PROJECTS.find((p) => p.id === 'liu2026doki')
  const images = [
    '/img/projects/Portfolio_Zhengyang Li_0116(1)_03.png',
    '/img/projects/Portfolio_Zhengyang Li_0116(1)_04.png',
    '/img/projects/Portfolio_Zhengyang Li_0116(1)_05.png',
    '/img/projects/Portfolio_Zhengyang Li_0116(1)_06.png',
    '/img/projects/Portfolio_Zhengyang Li_0116(1)_07.png',
  ]
  ...
  const orderedLinks = [
    ...
    { label: 'Paper', url: project.links?.paper },
    { label: 'Conference', url: project.links?.['HCII 2025'] },
