...
export default function ProjectDetail() {
  const project = PROJECTS.find((p) => p.id === 'liu2025uistdc')

  const images = [
    '/img/projects/Portfolio_Zhengyang Li_0116(1)_20.png',
    '/img/projects/Portfolio_Zhengyang Li_0116(1)_21.png',
    '/img/projects/Portfolio_Zhengyang Li_0116(1)_22.png',
    '/img/projects/Portfolio_Zhengyang Li_0116(1)_23.png',
  ]
  ...
  const orderedLinks = [
    ...
    { label: 'Paper', url: project.links?.pdf },
    { label: 'Conference', url: project.links?.['UIST 2025 DC'] },
